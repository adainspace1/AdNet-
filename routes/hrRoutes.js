...
// Dashboard
router.get('/', ensureAuthenticated, hrController.getHRDashboard);

// CRUD endpoints
router.post('/employee', ensureAuthenticated, hrController.createEmployee);
router.post('/worker', ensureAuthenticated, hrController.createWorker);
router.post('/contract', ensureAuthenticated, hrController.createContract);
router.post('/payroll', ensureAuthenticated, hrController.createPayroll);
router.post('/attendance', ensureAuthenticated, hrController.createAttendance);
router.post('/leave', ensureAuthenticated, hrController.createLeaveRequest);
